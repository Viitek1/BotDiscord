...
async def completa(ctx, arg, date, hora):
    ...
    emoji_ArcanoElevado = discord.utils.get(
        ctx.guild.emojis, id=1129135605402579005)
    emoji_ArcanoSilence = discord.utils.get(
        ctx.guild.emojis, id=1129135608250499192)
    emoji_MainHeal = discord.utils.get(
        ctx.guild.emojis, id=1129135614168670229)
    emoji_Corrompido = discord.utils.get(
        ctx.guild.emojis, id=1129135616576196688)
    ...
    emoji_QuebraReinos = discord.utils.get(
        ctx.guild.emojis, id=1129135628064391168)
    emoji_CacaEspirito = discord.utils.get(
        ctx.guild.emojis, id=1129135612453195877)
    emoji_Entalhada = discord.utils.get(
        ctx.guild.emojis, id=1129135618203590778)
    ...
    embed_main = msg_embed.add_field(
        name=f'{emoji_Maca}Main Tank ()', value="", inline=True)
    msg_embed.add_field(
        name=f'{emoji_Incubo}OFF Tank ()', value="", inline=True)
    msg_embed.add_field(
        name=f'{emoji_ArcanoElevado}Arcano Elevado()', value="", inline=True)
            ...
            match funcao:
                case 1129135625979822140:
                    ...
                    msg_embed1 = embed_main.set_field_at(
                        0, name=f'{emoji_Maca}Main Tank ({len(users)})', value=usernames, inline=True)
